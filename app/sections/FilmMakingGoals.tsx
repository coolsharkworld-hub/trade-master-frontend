...
export default function FilmMakingGoal({ data }: Props) {
  // Use Sanity data or fallback to pricing items
  const sectionData = data || {
    title: `Get everything you need to reach your filmmaking goals`,
  ...
  return (
    <div className='px-4 md:px-6 pt-8 md:pt-14 pb-16 md:pb-30 bg-white'>
      <h2 className='text-3xl lg:text-8xl sm:text-5xl fo`nt-medium mb-6 md:mb-8 text-black max-w-6xl text-center mx-auto leading-tight mt-10 md:mt-20'>
        {sectionData.title}
      </h2>
      <p className='text-lg md:text-2xl lg:text-2xl mx-auto text-center text-black leading-tight mb-8 md:mb-30'>
