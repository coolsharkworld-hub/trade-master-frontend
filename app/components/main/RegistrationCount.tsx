...
export const RegistrationCount = ({ time }: Props) => {
  ...
  return (
    <div className='mt-8 py-6 lg:px-6 px-2 max-w-xl mx-3 mb-8 mx-auto bg-inkwell-inception backdrop-blur-sm rounded-2xl'>
      ...
      <div className='flex lg:flex-row flex-col items-center justify-center mt-10 gap-5 w-full'>
        <Button
          variant='primary'
          className='lg:w-full text-sm lg:text-lg'
          endIcon={<ArrowRight />}
